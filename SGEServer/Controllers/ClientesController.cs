...
namespace SGEServer.Controllers
{
    public class ClientesController
    {
        ...
        public List<ClientesModel> CarregaClientesFisicosCadastrados(int CodEmpresa, string NomePessoa, string Cpf, string Celular)
        {
            try
            {
                var contexto = new DataBase(InfoConnection.DataConect);
                ...
                List<ParametroSql> list = new()
                {
                    ...
                    new ParametroSql("input", "", "NomePessoa", NomePessoa),
                    new ParametroSql("input", "", "Cpf", Cpf),
                    new ParametroSql("input", "", "Celular", Celular),
                };
        ...
        public List<ClientesModel> CarregaClientesJuridicosCadastrados(int CodCliente, string NomeFantasia, string RazaoSocial, string Cnpj)
        {
            ...
            try
            {
                ...
                List<ParametroSql> list = new()
                {
                    ...
                    new ParametroSql("input", "200", "RazaoSocial", RazaoSocial),
        ...
        public List<ClientesModel> CarregaEmpresasAPrazo(string NomeEncode, string IdentificacaoEncode, int CodEmpresa)
        {
            try
            {
                var contexto = new DataBase(InfoConnection.DataConect);
        ...
        public List<ClientesModel> CarregaHistoricoEmpresasAPrazo(int CodEmpresa)
        {
            try
            {
                var contexto = new DataBase(InfoConnection.DataConect);
                ...
                DataTable Dt = contexto.ExecutaComandoRetornoData("[SpConsulta018HistoricoEmpresasAPrazo]", list);
