...
namespace SGEServer.Controllers
{
    ...
    {
        public List<CotacaoModel> ListarCotacoesPendentes(int codEmpresa, string? numCotacao, string? NomeFantasia, string? NumOrdemCompra)
        {
            ...
            try
            {
                ...
                List<ParametroSql> list = new()
                {
                    ...
                    new ParametroSql("input", "12", "NumOrdemCompra", NumOrdemCompra!),
                };
                ...
                if (Dt != null)
                {
                    foreach (DataRow It in Dt.Rows)
                    {
                        dados.Add(new()
                        {
                            ...
                            NumOrdemCompra = It["NumOrdemCompra"].ToString()!,
        ...
        public List<CotacaoModel> ListarCotacoesFinalizadas(int codEmpresa, string? numCotacao, string? NomeEncode, string? IdentificacaoEnconde, string? OrdemCompra)
        {
            ...
            try
            {
                ...
                List<ParametroSql> list = new()
                {
                    new ParametroSql("input", "", "CodEmpresa", codEmpresa),
                    new ParametroSql("input", "12", "NumCotacao", numCotacao!),
                    new ParametroSql("input", "200", "NomeEncode", NomeEncode!),
                    new ParametroSql("input", "200", "IdentificacaoEncode", IdentificacaoEnconde!),
                ...
                if (Dt != null)
                {
                    foreach (DataRow It in Dt.Rows)
                    {
                        dados.Add(new()
                        {
                            ...
                            Status = It["DescricaoStatus"].ToString()!,
                            CodStatus = int.Parse(It["CodStatus"].ToString()!)
                        });
                    }
                }
                ...
                if (Dt != null)
                {
                    foreach (DataRow It in Dt.Rows)
                    {
                        dados.Add(new()
                        {
                            ...
                            CodStatus = int.Parse(It["CodStatus"].ToString()!),
                            StatusPagamento = It["StatusPagamento"].ToString()!,
                        });
                    }
                }
        ...
        public string CriarCotacao(int CodCliente, decimal ValorTotalCotacao, string NomeFantasia, string Cnpj, int PrazoEntregaRetornado, int FaturamentoRetornado,string Cpf,
                                   string NomePessoa, int CodEmpresa)
        {
            try
            {
                var contexto = new DataBase(InfoConnection.DataConect);
                ...
                List<ParametroSql> list = new()
                {
                    ...
                    new ParametroSql("input", "200", "NomeFantasia", NomeFantasia),
                    new ParametroSql("input", "200", "NomePessoa", NomePessoa),
                    new ParametroSql("input", "18", "Cnpj", Cnpj),
                    new ParametroSql("input", "14", "Cpf", Cpf),
        ...
        public List<CotacaoModel> CarregarCotacoes(int CodEmpresa,string NumCotacaoFiltro,string NomeEncode,string IdentificacaoEncode)
        {
            ...
            try
            {
                ...
                {
                    new ParametroSql("input", "12", "NumCotacaoFiltro", NumCotacaoFiltro),
                    new ParametroSql("input", "", "CodEmpresa", CodEmpresa),
                    new ParametroSql("input", "", "NomeEncode", NomeEncode),
                    new ParametroSql("input", "", "IdentificacaoEncode", IdentificacaoEncode),
                };

                DataTable dt = contexto.ExecutaComandoRetornoData("SpConsulta013RetornasCotacoesSalvas", parametros);
        ...
        public string EditarNumeroOrdemCompra(string NumCotacao, string NumOrdemCompra, int CodEmpresa)
        {
            try
            {
                ...
                return contexto.ExecutaComandoRetornoString("[SpOperacional026EditarNumOrdemCompra]", list);
            }
            catch (Exception exp)
            {
                throw new Exception($"Erro:! {exp.Message}");
        ...
        public bool VerificaCotacaoExistente(string NumCotacao, int CodEmpresa)
        {
            try
            {
                var contexto = new DataBase(InfoConnection.DataConect);
                List<ParametroSql> list = new List<ParametroSql>
                {
                    new ParametroSql("input", "12", "NumCotacao", NumCotacao),
                    new ParametroSql("input", "", "CodEmpresa", CodEmpresa),
                    new ParametroSql("output", "32", "Resp",  0)
                ...
                string Retorno = contexto.ExecutaComandoRetornoString("[SpConsulta020RetornaCotacaoExistente]", list);
            ...
            {
                throw new Exception($"Erro ao verificar dados para atrelar ordem de compra: {exp.Message}");
            }
        }
        ...
        public List<OrdemCompraModel> CarregaOrdemCompras(int CodEmpresa, string NumCotacaoFiltro, string NomeEncode, string IdentificacaoEncode, string NumOrdemCompraFiltro)
        {
            try
            {
                var contexto = new DataBase(InfoConnection.DataConect);
                List<ParametroSql> parametros = new List<ParametroSql>
                {
                    ...
                    new ParametroSql("input", "", "NomeEncode", NomeEncode),
                    new ParametroSql("input", "", "IdentificacaoEncode", IdentificacaoEncode),
                    new ParametroSql("input", "", "NumOrdemCompraFiltro", NumOrdemCompraFiltro),
                };
                List<OrdemCompraModel> listOrdemCompra = new List<OrdemCompraModel>();

                DataTable dt = contexto.ExecutaComandoRetornoData("[SpConsulta016RetornaOrdemCompraSalvas]", parametros);
