...
namespace SGEServer.Controllers
{
    public class PdfHelper
    {
        ...
        public async void GerarPDFHelper(string NomeCliente, string IdentificacaoCliente, string NumCotacao, int CodEmpresa, List<ProdutosModel> listProdutos, decimal ValorTotalCotacao, int PrazoEntregaRetornado, int FaturamentoRetornado)
        {
            ...
            string nomeArquivo = $"{NumCotacao}_{NomeCliente}.pdf";
